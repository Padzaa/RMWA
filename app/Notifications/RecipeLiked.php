...
class RecipeLiked extends Notification implements ShouldQueue
{
    ...
    {
        return ['recipeLiked' => \App\Models\Notification::where('notifiable_id', $this->notifiable)->where('type', 'App\Notifications\RecipeLiked')->where('read_at', null)->get()->toArray()];
    }
}

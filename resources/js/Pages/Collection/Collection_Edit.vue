    ...
    data(){
        return {
            form:{
                ...
                recipes: this.collection.recipes,
            }
        }
    },
    methods:{
    ...
    <div class="form">
        <form @submit.prevent="submit">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="collection_name" name="name" v-model="form.name" placeholder="Enter collection name" required>

    ...
    <div class="recipe">
      <div class="show-header">
        <span>Created by <Link class="owner"
                               :href="'/user/' + recipe.user_id">{{ recipe.user.firstname + " " + recipe.user.lastname }}</Link> </span>
        <Link v-if="this.$attrs.auth ? this.$attrs.auth.user.id == recipe.user_id : false" class="heart" method="PUT"
        ...
        <div class="rate-me">
          ...
          <div class="modals">
            ...
            <div v-if=" this.$attrs.auth ? this.$attrs.auth.user.id == recipe.user_id : false"
                 class="modal fade" :id="'shareModal'+recipe.id" tabindex="-1" aria-labelledby="shareModalLabel"
                 aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button @click="submitShare" type="submit" class="btn btn-danger text-white" id="shareRecipe">Share</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="modal fade" :id="'exampleModal'+recipe.id" tabindex="-1" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary text-white" data-bs-dismiss="modal">Cancel</button>
                    <button @click="submitReview" type="submit" class="btn btn-danger text-white" id="rate_recipe">Rate</button>
                  </div>
                </div>
              </div>
            </div>

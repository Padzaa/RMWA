    ...
    <div class="container rounded bg-white mt-5 mb-5">
        ...
        <div class="row justify-content-center">
                ...
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    <label for="fileToUpload">
                        <div class="profile-pic">
                            <img
                                :src="user.picture ? user.picture : 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png'"
                                alt="">
                        </div>
                    </label>
            ...
            <div v-if="user.id !== this.$attrs.auth.user.id" class="follow">
                <Link :href="'/user/' + user.id + '/follow'" method="PUT"
